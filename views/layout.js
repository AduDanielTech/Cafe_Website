module.exports = ({ content }) => {
    ...
    <head>
        ...
        <meta property="og:image" content="https://github.com/AduDanielTech/Cafe_Website/tree/main/public/image/meta_image.png?raw=true">
        ...
        <!-- Library Stylesheets -->
        <link  type="text/css" href="/lib/animate/animate.min.css" rel="stylesheet">
    ...
    <div class='toast-cont'> 
        ...
        <!-- Libraries -->
        <script type="application/javascript" src="/lib/wow/wow.min.js"></script>
        <script type="application/javascript" src="/lib/easing/easing.min.js"></script>
        <script type="application/javascript" src="/lib/counterup/counterup.min.js"></script>
